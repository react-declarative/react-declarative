...
declare module 'react-declarative/components/One/layouts/PaperLayout' {
    ...
    export const PaperLayout: {
        <Data extends unknown = any>({ columns, columnsOverride, sx, phoneColumns, tabletColumns, desktopColumns, style, className, children, isBaselineAlign, fieldRightMargin, fieldBottomMargin, innerPadding: padding, outlinePaper, transparentPaper, }: IPaperLayoutProps<Data, any> & IPaperLayoutPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ columns, columnsOverride, sx, phoneColumns, tabletColumns, desktopColumns, style, className, children, isBaselineAlign, fieldRightMargin, fieldBottomMargin, innerPadding: padding, outlinePaper, transparentPaper, }: IPaperLayoutProps<Data, any> & IPaperLayoutPrivate): JSX.Element;
...
declare module 'react-declarative/components/One/layouts/ExpansionLayout' {
    ...
    export const ExpansionLayout: {
        <Data extends unknown = any>({ columns, columnsOverride, sx, phoneColumns, tabletColumns, desktopColumns, isBaselineAlign, fieldRightMargin, fieldBottomMargin, style, className, children, title, description, expansionOpened, outlinePaper, transparentPaper, }: IExpansionLayoutProps<Data, any> & IExpansionLayoutPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ columns, columnsOverride, sx, phoneColumns, tabletColumns, desktopColumns, isBaselineAlign, fieldRightMargin, fieldBottomMargin, style, className, children, title, description, expansionOpened, outlinePaper, transparentPaper, }: IExpansionLayoutProps<Data, any> & IExpansionLayoutPrivate): JSX.Element;
...
declare module 'react-declarative/components/One/fields/FileField' {
    ...
    export const FileField: {
        ({ invalid, value, disabled, readonly, description, outlined, title, placeholder, incorrect, upload, view, dirty, labelShrink, loading, onChange, inputRef, name, }: IFileFieldProps & IFileFieldPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ className, sx, columns, phoneColumns, tabletColumns, desktopColumns, isDisabled: isDisabledUpper, isVisible: isVisibleUpper, isInvalid: isInvalidUpper, isIncorrect: isIncorrectUpper, isReadonly: isReadonlyUpper, change, fallback, ready, compute: upperCompute, shouldRecompute, click, map, object: upperObject, name, title, menu, debug, focus, blur, invalidity, prefix, dirty: upperDirty, disabled: fieldDisabled, readonly: upperReadonly, autoFocus, style, menuItems, groupRef: ref, fieldRightMargin, fieldBottomMargin, outlinePaper, transparentPaper, ...otherProps }: import("../../../model/IEntity").IEntity<Data, any>): JSX.Element | null;
...
declare module 'react-declarative/components/One/fields/ComponentField' {
    ...
    export const ComponentField: {
        ({ disabled, readonly, watchOneContext, element: Element, outlinePaper, transparentPaper, object, ...otherProps }: IComponentFieldProps & IComponentFieldPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ className, sx, columns, phoneColumns, tabletColumns, desktopColumns, isDisabled: isDisabledUpper, isVisible: isVisibleUpper, isInvalid: isInvalidUpper, isIncorrect: isIncorrectUpper, isReadonly: isReadonlyUpper, change, fallback, ready, compute: upperCompute, shouldRecompute, click, map, object: upperObject, name, title, menu, debug, focus, blur, invalidity, prefix, dirty: upperDirty, disabled: fieldDisabled, readonly: upperReadonly, autoFocus, style, menuItems, groupRef: ref, fieldRightMargin, fieldBottomMargin, outlinePaper, transparentPaper, ...otherProps }: import("../../../model/IEntity").IEntity<Data, any>): JSX.Element | null;
...
declare module 'react-declarative/components/One/fields/YesNoField' {
    ...
    export const YesNoField: {
        ({ value, disabled, readonly, description, placeholder, outlined, virtualListBox, noDeselect, labelShrink, title, tr, dirty, invalid, incorrect, onChange, }: IYesNoFieldProps & IYesNoFieldPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ className, sx, columns, phoneColumns, tabletColumns, desktopColumns, isDisabled: isDisabledUpper, isVisible: isVisibleUpper, isInvalid: isInvalidUpper, isIncorrect: isIncorrectUpper, isReadonly: isReadonlyUpper, change, fallback, ready, compute: upperCompute, shouldRecompute, click, map, object: upperObject, name, title, menu, debug, focus, blur, invalidity, prefix, dirty: upperDirty, disabled: fieldDisabled, readonly: upperReadonly, autoFocus, style, menuItems, groupRef: ref, fieldRightMargin, fieldBottomMargin, outlinePaper, transparentPaper, ...otherProps }: import("../../../model/IEntity").IEntity<Data, any>): JSX.Element | null;
...
declare module 'react-declarative/components/One/fields/DictField' {
    ...
    export const DictField: {
        ({ invalid, incorrect, value, disabled, readonly, inputType, inputAutocomplete, description, outlined, title, placeholder, dirty, loading, onChange, dictLimit, dictDelay, dictSearch, dictOnAppend, dictOnText, dictOnItem, dictValue, dictSearchText, dictSearchItem, dictCreateButton, inputMode, inputPattern, groupRef, inputRef, inputFormatter, inputFormatterAllowed, inputFormatterReplace, inputFormatterSymbol, inputFormatterTemplate, name, leadingIcon, trailingIcon, leadingIconClick, trailingIconClick, leadingIconRipple, trailingIconRipple, }: IDictFieldProps & IDictFieldPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ className, sx, columns, phoneColumns, tabletColumns, desktopColumns, isDisabled: isDisabledUpper, isVisible: isVisibleUpper, isInvalid: isInvalidUpper, isIncorrect: isIncorrectUpper, isReadonly: isReadonlyUpper, change, fallback, ready, compute: upperCompute, shouldRecompute, click, map, object: upperObject, name, title, menu, debug, focus, blur, invalidity, prefix, dirty: upperDirty, disabled: fieldDisabled, readonly: upperReadonly, autoFocus, style, menuItems, groupRef: ref, fieldRightMargin, fieldBottomMargin, outlinePaper, transparentPaper, ...otherProps }: import("../../../model/IEntity").IEntity<Data, any>): JSX.Element | null;
...
declare module 'react-declarative/components/common/Group/Group' {
    ...
    export const Group: {
        ({ className, columns, phoneColumns, tabletColumns, desktopColumns, children, isItem, isBaselineAlign, style, columnsOverride, sx, fieldRightMargin, fieldBottomMargin, onClick, onFocus, onContextMenu, ...otherProps }: IGroupProps & IGroupPrivate, ref: React.Ref<HTMLDivElement>): JSX.Element;
        displayName: string;
    };
...
declare module 'react-declarative/components/GridView/components/Card' {
    ...
    export const Card: ({ children, outlinePaper, transparentPaper, className, style, sx, label, payload, loading, BeforeLabel, AfterLabel, }: ICardProps) => JSX.Element;
    export default Card;
}
