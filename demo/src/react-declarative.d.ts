...
declare module 'react-declarative/model/IListProps' {
    ...
    export type ListHandler<FilterData extends {} = IAnything, RowData extends IRowData = IAnything> = RowData[] | ((data: FilterData, pagination: ListHandlerPagination, sort: ListHandlerSortModel<RowData>, chips: ListHandlerChips<RowData>, search: string) => Promise<ListHandlerResult<RowData>> | ListHandlerResult<RowData>);
...
declare module 'react-declarative/components/One/fields/CompleteField' {
    ...
    export const CompleteField: {
        ({ invalid, value, disabled, readonly, inputType, description, outlined, title, leadingIcon, trailingIcon, leadingIconClick, trailingIconClick, tip, placeholder, inputAutocomplete, dirty, loading, onChange, autoFocus, inputRef, name, }: ICompleteFieldProps & ICompleteFieldPrivate): JSX.Element;
        displayName: string;
    };
    const _default: {
        <Data extends unknown = any>({ className, sx, columns, phoneColumns, tabletColumns, desktopColumns, isDisabled, isVisible, isInvalid, isReadonly, change, fallback, ready, compute, object: upperObject, name, title, focus, blur, invalidity, prefix, dirty: upperDirty, disabled: fieldDisabled, readonly: upperReadonly, autoFocus, style, groupRef: ref, fieldRightMargin, fieldBottomMargin, ...otherProps }: import("../../../model/IEntity").IEntity<Data, any>): JSX.Element;
...
declare module 'react-declarative/components/List/api/useLastPagination' {
    ...
    export const useLastPagination: <FilterData extends {} = any, RowData extends IRowData = any>(upperHandler: ListHandler<FilterData, RowData>) => IResult;
...
declare module 'react-declarative/components/List/api/useCachedPaginator' {
    ...
    export const useCachedPaginator: <FilterData extends {} = any, RowData extends IRowData = any>(handler: ListHandler<FilterData, RowData>, params: IArrayPaginatorParams<FilterData, RowData>) => IResult<FilterData, RowData>;
...
declare module 'react-declarative/components/Async/Async' {
    ...
    type Result = React.ReactNode | void;
    export const Async: <T extends unknown = object>({ children, fallback, Loader, Error, onLoadStart, onLoadEnd, payload, deps, throwError, }: IAsyncProps<T>) => JSX.Element;
...
declare module 'react-declarative/components/MasterDetail/MasterDetail' {
    ...
    export const MasterDetail: <Payload extends unknown = any>({ mode, withSideMenuCollapse, withFixedPos, title, className, style, sx, activeOption: upperActiveOption, payload, deps, options, children, Loader, Error, onActiveOptionChange, fallback, onLoadStart, onLoadEnd, throwError, }: IMasterDetailProps<Payload>) => JSX.Element;
