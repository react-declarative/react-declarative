 ...
 * @param {number} strideSize The size of each stride.
 * @param {number} [step=Math.floor(strideSize / 2)] The step size between each stride.
 * @returns {TObserver<T[][]>} The transformed observer that emits strided data.
