 ...
 * @param {Function} options.handler - The handler function to be called when a row is selected.
 * @param {Array} options.columns - The columns to be displayed in the ListPicker.
 * @param {Array} options.rowActions - The actions to be displayed for each row in the ListPicker.
 * @param {any} options.payload - The payload to be passed to the ListPicker component.
 * @param {Array} options.features - The features to be enabled in the ListPicker.
 * @param {string} [options.selectionMode=SelectionMode.Single] - The selection mode for the ListPicker.
 * @param {string} [options.title="Pick item"] - The title of the ListPicker modal.
 * @param {number} [options.minWidth=425] - The minimum width of the ListPicker modal.
 * @param {number} [options.minHeight=375] - The minimum height of the ListPicker modal.
 * @param {Array} [options.selectedRows] - The initially selected rows in the ListPicker.
 *
 * @returns {Function} - A function that creates and opens the ListPicker modal.
 *
 * @example
