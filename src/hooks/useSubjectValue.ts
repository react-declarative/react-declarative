 ...
 * @param {TSubject<Data>} target - The subject to subscribe to.
 * @param {Data | (() => Data)} [value] - The initial value for the subject, if not provided the subject's initial value will be used.
 * @returns {Data} - The current value of the subject.
 */
