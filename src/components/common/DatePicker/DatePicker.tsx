 ...
 * @returns A makeStyles hook that can be used to create custom styles.
 *
 * @param theme - The theme object used for providing style properties.
 * @param theme.palette - The palette object used for defining color properties.
 * @param theme.palette.primary.main - The color used for the background of the toolbar.
 *
 * @returns The custom styles object containing the styles for the container and the toolbar.
 * @returns styles.container - The styles for the container.
 * @returns styles.container.width - The width of the container.
 * @returns styles.container.height - The height of the container.
 * @returns styles.toolbar - The styles for the toolbar.
 * @returns styles.toolbar.backgroundColor - The background color of the toolbar.
 * @returns styles.toolbar.display - The display property of the toolbar.
 * @returns styles.toolbar.flexDirection - The flex direction property of the toolbar.
 * @returns styles.toolbar.alignItems - The align items property of the toolbar.
 * @returns styles.toolbar.justifyContent - The justify content property of the toolbar.
 * @returns styles.toolbar.height - The height of the toolbar.
 */
