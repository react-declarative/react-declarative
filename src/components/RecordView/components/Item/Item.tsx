...
export const Item = ({
   ...
   * @param upperValue - The upper value to be formatted.
   * @param path - The path of the item.
   * @param formatValue - The function used to format the value.
  ...
  return (
    ...
    >
      <Grid item xs={keyWidth}>
        <Typography variant="body1" sx={{ ml: 1, overflow: 'clip' }}>{formatKey(itemKey, path)}</Typography>
      </Grid>
